...
namespace Amns.Tessen.Web.UI.WebControls
{
	/// <summary>
	/// <summary>
	/// A delete dialog for DojoPromotionStatus.
	/// </summary>
	/// </summary>
	[ToolboxData("<DojoPromotionStatus:DojoPromotionStatusDeleteDialog runat=server></{0}:DojoPromotionStatusDeleteDialog>")]
	public class DojoPromotionStatusDeleteDialog : TableWindow
	{

		private int dojoPromotionStatusID = -1;
		...
		protected override void RenderContent(HtmlTextWriter output)
		{
			if(dojoPromotionStatusID == 0)
			{
				...
				output.Write("The DojoPromotionStatus selected does not exist.");
			...
			output.Write("<strong>Warning:</strong> This action deletes the selected Promotion Status." +
			...
			output.Write(HtmlTextWriter.TagRightChar);
			output.Write("Promotion Status to delete: ");
			output.WriteEndTag("td");
			output.WriteBeginTag("td");
			output.WriteAttribute("class", "row1");
			output.WriteAttribute("width", "100%");
			output.Write(HtmlTextWriter.TagRightChar);
			output.Write(dojoPromotionStatus.ToString());
			output.WriteEndTag("td");
			output.WriteEndTag("tr");
