...
namespace Amns.Tessen.Web.UI.WebControls
{
	/// <summary>
	/// <summary>
	/// A delete dialog for DojoPromotionFlag.
	/// </summary>
	/// </summary>
	[ToolboxData("<DojoPromotionFlag:DojoPromotionFlagDeleteDialog runat=server></{0}:DojoPromotionFlagDeleteDialog>")]
	public class DojoPromotionFlagDeleteDialog : TableWindow
	{

		private int dojoPromotionFlagID = -1;
		...
		protected override void RenderContent(HtmlTextWriter output)
		{
			if(dojoPromotionFlagID == 0)
			{
				...
				output.Write("The DojoPromotionFlag selected does not exist.");
			...
			output.Write(HtmlTextWriter.TagRightChar);
			output.Write(dojoPromotionFlag.ToString());
			output.WriteEndTag("td");
			output.WriteEndTag("tr");
