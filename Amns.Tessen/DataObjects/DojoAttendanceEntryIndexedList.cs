...
namespace Amns.GreyFox.Tessen
{
	...
	/// </summary>
	/// </summary>
	public class DojoAttendanceEntryIndexedList : IList, ICloneable 
	{
		private int count = 0;
		private int[,] index;
		private DojoAttendanceEntry[] DojoAttendanceEntryArray ;

		public DojoAttendanceEntryIndexedList() : base()
		{
			index = new int[15,2];
			DojoAttendanceEntryArray = new DojoAttendanceEntry[15];
		}

		public DojoAttendanceEntryIndexedList(int capacity) : base()
		{
		...
		public void RemoveAt(int index)
		{
			...
			lock(this)
			{
				removeIndexKey(DojoAttendanceEntryArray[index].ID);
