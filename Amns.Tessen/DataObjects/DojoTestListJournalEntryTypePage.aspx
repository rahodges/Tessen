...
<%@ Page language="c#" CodeFile="DojoTestListJournalEntryTypePage.aspx.cs" Inherits="TessenWeb.Administration.DojoTestListJournalEntryTypePage" trace="false" %>
						...
						<table id="Table1" cellSpacing="0" cellPadding="3" width="100%" border="0" height="100%">
							...
							<tr>
								...
								<td vAlign="top" width="100%">
									<cc1:DojoTestListJournalEntryTypeGrid id="DojoTestListJournalEntryTypeGrid1" runat="server" Width="100%" BorderWidth="0px" Height="100%" 
										...
										Text=""
										></cc1:DojoTestListJournalEntryTypeGrid>
									<cc1:DojoTestListJournalEntryTypeEditor id="DojoTestListJournalEntryTypeEditor1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" Editor"
										></cc1:DojoTestListJournalEntryTypeEditor>
									<cc1:DojoTestListJournalEntryTypeView id="DojoTestListJournalEntryTypeView1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" View"
										></cc1:DojoTestListJournalEntryTypeView>
								</td>
							</tr>
							<tr>
