...
namespace Amns.Tessen.Web.UI.WebControls
{
	/// <summary>
	/// <summary>
	/// A custom grid for DojoAccessControlGroup.
	/// </summary>
	/// </summary>
	[ToolboxData("<{0}:DojoAccessControlGroupGrid runat=server></{0}:DojoAccessControlGroupGrid>")]
	public class DojoAccessControlGroupGrid : TableGrid
	{
