...
namespace Amns.Tessen.Web.UI.WebControls
{
	/// <summary>
	/// <summary>
	/// A delete dialog for DojoTestListJournalEntry.
	/// </summary>
	/// </summary>
	[ToolboxData("<DojoTestListJournalEntry:DojoTestListJournalEntryDeleteDialog runat=server></{0}:DojoTestListJournalEntryDeleteDialog>")]
	public class DojoTestListJournalEntryDeleteDialog : TableWindow
	{

		private int dojoTestListJournalEntryID = -1;
		...
		protected override void RenderContent(HtmlTextWriter output)
		{
			if(dojoTestListJournalEntryID == 0)
			{
				...
				output.Write("The DojoTestListJournalEntry selected does not exist.");
			...
			output.Write(HtmlTextWriter.TagRightChar);
			output.Write(dojoTestListJournalEntry.ToString());
			output.WriteEndTag("td");
			output.WriteEndTag("tr");
