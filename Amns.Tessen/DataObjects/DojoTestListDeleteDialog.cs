...
namespace Amns.Tessen.Web.UI.WebControls
{
	/// <summary>
	/// <summary>
	/// A delete dialog for DojoTestList.
	/// </summary>
	/// </summary>
	[ToolboxData("<DojoTestList:DojoTestListDeleteDialog runat=server></{0}:DojoTestListDeleteDialog>")]
	public class DojoTestListDeleteDialog : TableWindow
	{

		private int dojoTestListID = -1;
		...
		protected override void RenderContent(HtmlTextWriter output)
		{
			if(dojoTestListID == 0)
			{
				...
				output.Write("The DojoTestList selected does not exist.");
			...
			output.Write(HtmlTextWriter.TagRightChar);
			output.Write(dojoTestList.ToString());
			output.WriteEndTag("td");
			output.WriteEndTag("tr");
