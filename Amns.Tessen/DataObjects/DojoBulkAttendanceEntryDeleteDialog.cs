...
namespace Amns.Tessen.Web.UI.WebControls
{
	/// <summary>
	/// <summary>
	/// A delete dialog for DojoBulkAttendanceEntry.
	/// </summary>
	/// </summary>
	[ToolboxData("<DojoBulkAttendanceEntry:DojoBulkAttendanceEntryDeleteDialog runat=server></{0}:DojoBulkAttendanceEntryDeleteDialog>")]
	public class DojoBulkAttendanceEntryDeleteDialog : TableWindow
	{

		private int dojoBulkAttendanceEntryID = -1;
		...
		protected override void RenderContent(HtmlTextWriter output)
		{
			if(dojoBulkAttendanceEntryID == 0)
			{
				...
				output.Write("The DojoBulkAttendanceEntry selected does not exist.");
			...
			output.Write(HtmlTextWriter.TagRightChar);
			output.Write(dojoBulkAttendanceEntry.ToString());
			output.WriteEndTag("td");
			output.WriteEndTag("tr");
