...
<%@ Page language="c#" CodeFile="DojoMembershipTemplatePage.aspx.cs" Inherits="TessenWeb.Administration.DojoMembershipTemplatePage" trace="false" %>
						...
						<table id="Table1" cellSpacing="0" cellPadding="3" width="100%" border="0" height="100%">
							...
							<tr>
								...
								<td vAlign="top" width="100%">
									<cc1:DojoMembershipTemplateGrid id="DojoMembershipTemplateGrid1" runat="server" Width="100%" BorderWidth="0px" Height="100%" 
										...
										Text=""
										></cc1:DojoMembershipTemplateGrid>
									<cc1:DojoMembershipTemplateEditor id="DojoMembershipTemplateEditor1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" Editor"
										></cc1:DojoMembershipTemplateEditor>
									<cc1:DojoMembershipTemplateView id="DojoMembershipTemplateView1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" View"
										></cc1:DojoMembershipTemplateView>
								</td>
							</tr>
							<tr>
