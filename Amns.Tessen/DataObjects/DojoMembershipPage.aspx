...
<%@ Page language="c#" CodeFile="DojoMembershipPage.aspx.cs" Inherits="TessenWeb.Administration.DojoMembershipPage" trace="false" %>
						...
						<table id="Table1" cellSpacing="0" cellPadding="3" width="100%" border="0" height="100%">
							...
							<tr>
								...
								<td vAlign="top" width="100%">
									<cc1:DojoMembershipGrid id="DojoMembershipGrid1" runat="server" Width="100%" BorderWidth="0px" Height="100%" 
										...
										Text=""
										></cc1:DojoMembershipGrid>
									<cc1:DojoMembershipEditor id="DojoMembershipEditor1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" Editor"
										></cc1:DojoMembershipEditor>
									<cc1:DojoMembershipView id="DojoMembershipView1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" View"
										></cc1:DojoMembershipView>
								</td>
							</tr>
							<tr>
