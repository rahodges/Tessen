...
<%@ Page language="c#" CodeFile="DojoClassDefinitionPage.aspx.cs" Inherits="TessenWeb.Administration.DojoClassDefinitionPage" trace="false" %>
							...
							<tr>
								<td vAlign="top">
									<table id="LeftMenu" class="forumLine" cellSpacing="1" cellPadding="3" width="200" border="0">
										<tr><th></th></tr>
										<tr><td>Class definitions for generating class entries in the class log. These automatically generate if specified with recurrence. can be accessed here</td></tr>
									</table>
								</td>
								<td vAlign="top" width="100%">
									<cc1:DojoClassDefinitionGrid id="DojoClassDefinitionGrid1" runat="server" Width="100%" BorderWidth="0px" Height="100%" 
										...
										Text=""
										></cc1:DojoClassDefinitionGrid>
									<cc1:DojoClassDefinitionEditor id="DojoClassDefinitionEditor1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" Editor"
										></cc1:DojoClassDefinitionEditor>
									<cc1:DojoClassDefinitionView id="DojoClassDefinitionView1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" View"
										></cc1:DojoClassDefinitionView>
								</td>
							</tr>
							<tr>
