...
namespace Amns.Tessen.Web.UI.WebControls
{
	/// <summary>
	/// <summary>
	/// A delete dialog for DojoMember.
	/// </summary>
	/// </summary>
	[ToolboxData("<DojoMember:DojoMemberDeleteDialog runat=server></{0}:DojoMemberDeleteDialog>")]
	public class DojoMemberDeleteDialog : TableWindow
	{

		private int dojoMemberID = -1;
