...
<%@ Page language="c#" CodeFile="DojoTestListStatusPage.aspx.cs" Inherits="TessenWeb.Administration.DojoTestListStatusPage" trace="false" %>
						...
						<table id="Table1" cellSpacing="0" cellPadding="3" width="100%" border="0" height="100%">
							...
							<tr>
								...
								<td vAlign="top" width="100%">
									<cc1:DojoTestListStatusGrid id="DojoTestListStatusGrid1" runat="server" Width="100%" BorderWidth="0px" Height="100%" 
										...
										Text=""
										></cc1:DojoTestListStatusGrid>
									<cc1:DojoTestListStatusEditor id="DojoTestListStatusEditor1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" Editor"
										></cc1:DojoTestListStatusEditor>
									<cc1:DojoTestListStatusView id="DojoTestListStatusView1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" View"
										></cc1:DojoTestListStatusView>
								</td>
							</tr>
							<tr>
