...
<%@ Page language="c#" CodeFile="DojoMemberTypePage.aspx.cs" Inherits="TessenWeb.Administration.DojoMemberTypePage" trace="false" %>
							...
							<tr>
								<td vAlign="top">
									<table id="LeftMenu" class="forumLine" cellSpacing="1" cellPadding="3" width="200" border="0">
										<tr><th></th></tr>
										<tr><td>Member types allow separate fees, classes, organizations, seminars and tests for dojo members. can be accessed here</td></tr>
									</table>
								</td>
								<td vAlign="top" width="100%">
									<cc1:DojoMemberTypeGrid id="DojoMemberTypeGrid1" runat="server" Width="100%" BorderWidth="0px" Height="100%" 
										...
										Text=""
										></cc1:DojoMemberTypeGrid>
									<cc1:DojoMemberTypeEditor id="DojoMemberTypeEditor1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" Editor"
										></cc1:DojoMemberTypeEditor>
									<cc1:DojoMemberTypeView id="DojoMemberTypeView1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" View"
										></cc1:DojoMemberTypeView>
								</td>
							</tr>
							<tr>
