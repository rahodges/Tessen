...
namespace Amns.Tessen.Web.UI.WebControls
{
	/// <summary>
	/// <summary>
	/// A delete dialog for DojoMemberType.
	/// </summary>
	/// </summary>
	[ToolboxData("<DojoMemberType:DojoMemberTypeDeleteDialog runat=server></{0}:DojoMemberTypeDeleteDialog>")]
	public class DojoMemberTypeDeleteDialog : TableWindow
	{

		private int dojoMemberTypeID = -1;
		private DojoMemberType dojoMemberType;
		...
		protected override void RenderContent(HtmlTextWriter output)
		{
			if(dojoMemberTypeID == 0)
			{
				...
				output.Write("The DojoMemberType selected does not exist.");
			...
			output.Write(HtmlTextWriter.TagRightChar);
			output.Write(dojoMemberType.ToString());
			output.WriteEndTag("td");
			output.WriteEndTag("tr");
