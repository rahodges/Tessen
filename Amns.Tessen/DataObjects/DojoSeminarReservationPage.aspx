...
<%@ Page language="c#" CodeFile="DojoSeminarReservationPage.aspx.cs" Inherits="TessenWeb.Administration.DojoSeminarReservationPage" trace="false" %>
						...
						<table id="Table1" cellSpacing="0" cellPadding="3" width="100%" border="0" height="100%">
							...
							<tr>
								...
								<td vAlign="top" width="100%">
									<cc1:DojoSeminarReservationGrid id="DojoSeminarReservationGrid1" runat="server" Width="100%" BorderWidth="0px" Height="100%" 
										...
										Text=""
										></cc1:DojoSeminarReservationGrid>
									<cc1:DojoSeminarReservationEditor id="DojoSeminarReservationEditor1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" Editor"
										></cc1:DojoSeminarReservationEditor>
									<cc1:DojoSeminarReservationView id="DojoSeminarReservationView1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" View"
										></cc1:DojoSeminarReservationView>
								</td>
							</tr>
							<tr>
