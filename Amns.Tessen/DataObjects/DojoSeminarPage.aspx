...
<%@ Page language="c#" CodeFile="DojoSeminarPage.aspx.cs" Inherits="TessenWeb.Administration.DojoSeminarPage" trace="false" %>
						...
						<table id="Table1" cellSpacing="0" cellPadding="3" width="100%" border="0" height="100%">
							...
							<tr>
								...
								<td vAlign="top" width="100%">
									<cc1:DojoSeminarGrid id="DojoSeminarGrid1" runat="server" Width="100%" BorderWidth="0px" Height="100%" 
										...
										Text=""
										></cc1:DojoSeminarGrid>
									<cc1:DojoSeminarEditor id="DojoSeminarEditor1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" Editor"
										></cc1:DojoSeminarEditor>
									<cc1:DojoSeminarView id="DojoSeminarView1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" View"
										></cc1:DojoSeminarView>
								</td>
