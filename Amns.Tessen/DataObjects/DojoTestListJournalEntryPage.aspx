...
<%@ Page language="c#" CodeFile="DojoTestListJournalEntryPage.aspx.cs" Inherits="TessenWeb.Administration.DojoTestListJournalEntryPage" trace="false" %>
						...
						<table id="Table1" cellSpacing="0" cellPadding="3" width="100%" border="0" height="100%">
							...
							<tr>
								...
								<td vAlign="top" width="100%">
									<cc1:DojoTestListJournalEntryGrid id="DojoTestListJournalEntryGrid1" runat="server" Width="100%" BorderWidth="0px" Height="100%" 
										...
										Text=""
										></cc1:DojoTestListJournalEntryGrid>
									<cc1:DojoTestListJournalEntryEditor id="DojoTestListJournalEntryEditor1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" Editor"
										></cc1:DojoTestListJournalEntryEditor>
									<cc1:DojoTestListJournalEntryView id="DojoTestListJournalEntryView1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" View"
										></cc1:DojoTestListJournalEntryView>
								</td>
							</tr>
							<tr>
