...
namespace Amns.Tessen.Web.UI.WebControls
{
	/// <summary>
	/// <summary>
	/// A delete dialog for DojoMembership.
	/// </summary>
	/// </summary>
	[ToolboxData("<DojoMembership:DojoMembershipDeleteDialog runat=server></{0}:DojoMembershipDeleteDialog>")]
	public class DojoMembershipDeleteDialog : TableWindow
	{

		private int dojoMembershipID = -1;
