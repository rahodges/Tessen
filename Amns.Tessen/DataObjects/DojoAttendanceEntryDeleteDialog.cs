...
namespace Amns.Tessen.Web.UI.WebControls
{
	/// <summary>
	/// <summary>
	/// A delete dialog for DojoAttendanceEntry.
	/// </summary>
	/// </summary>
	[ToolboxData("<DojoAttendanceEntry:DojoAttendanceEntryDeleteDialog runat=server></{0}:DojoAttendanceEntryDeleteDialog>")]
	public class DojoAttendanceEntryDeleteDialog : TableWindow
	{

		private int dojoAttendanceEntryID = -1;
		...
		protected override void RenderContent(HtmlTextWriter output)
		{
			if(dojoAttendanceEntryID == 0)
			{
				...
				output.Write("The DojoAttendanceEntry selected does not exist.");
			...
			output.Write(HtmlTextWriter.TagRightChar);
			output.Write(dojoAttendanceEntry.ToString());
			output.WriteEndTag("td");
			output.WriteEndTag("tr");
