...
namespace Amns.Tessen.Web.UI.WebControls
{
	/// <summary>
	/// <summary>
	/// A delete dialog for DojoSeminar.
	/// </summary>
	/// </summary>
	[ToolboxData("<DojoSeminar:DojoSeminarDeleteDialog runat=server></{0}:DojoSeminarDeleteDialog>")]
	public class DojoSeminarDeleteDialog : TableWindow
	{

		private int dojoSeminarID = -1;
