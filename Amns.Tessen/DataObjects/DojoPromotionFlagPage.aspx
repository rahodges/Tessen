...
<%@ Page language="c#" CodeFile="DojoPromotionFlagPage.aspx.cs" Inherits="TessenWeb.Administration.DojoPromotionFlagPage" trace="false" %>
						...
						<table id="Table1" cellSpacing="0" cellPadding="3" width="100%" border="0" height="100%">
							...
							<tr>
								...
								<td vAlign="top" width="100%">
									<cc1:DojoPromotionFlagGrid id="DojoPromotionFlagGrid1" runat="server" Width="100%" BorderWidth="0px" Height="100%" 
										...
										Text=""
										></cc1:DojoPromotionFlagGrid>
									<cc1:DojoPromotionFlagEditor id="DojoPromotionFlagEditor1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" Editor"
										></cc1:DojoPromotionFlagEditor>
									<cc1:DojoPromotionFlagView id="DojoPromotionFlagView1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" View"
										></cc1:DojoPromotionFlagView>
								</td>
							</tr>
							<tr>
