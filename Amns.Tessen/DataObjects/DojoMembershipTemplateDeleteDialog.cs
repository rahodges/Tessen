...
namespace Amns.Tessen.Web.UI.WebControls
{
	/// <summary>
	/// <summary>
	/// A delete dialog for DojoMembershipTemplate.
	/// </summary>
	/// </summary>
	[ToolboxData("<DojoMembershipTemplate:DojoMembershipTemplateDeleteDialog runat=server></{0}:DojoMembershipTemplateDeleteDialog>")]
	public class DojoMembershipTemplateDeleteDialog : TableWindow
	{

		private int dojoMembershipTemplateID = -1;
