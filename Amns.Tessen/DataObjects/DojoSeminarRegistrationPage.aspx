...
<%@ Page language="c#" CodeFile="DojoSeminarRegistrationPage.aspx.cs" Inherits="TessenWeb.Administration.DojoSeminarRegistrationPage" trace="false" %>
						...
						<table id="Table1" cellSpacing="0" cellPadding="3" width="100%" border="0" height="100%">
							...
							<tr>
								...
								<td vAlign="top" width="100%">
									<cc1:DojoSeminarRegistrationGrid id="DojoSeminarRegistrationGrid1" runat="server" Width="100%" BorderWidth="0px" Height="100%" 
										...
										Text=""
										></cc1:DojoSeminarRegistrationGrid>
									<cc1:DojoSeminarRegistrationEditor id="DojoSeminarRegistrationEditor1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" Editor"
										></cc1:DojoSeminarRegistrationEditor>
									<cc1:DojoSeminarRegistrationView id="DojoSeminarRegistrationView1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" View"
										></cc1:DojoSeminarRegistrationView>
								</td>
							</tr>
							<tr>
