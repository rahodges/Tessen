...
namespace Amns.Tessen.Web.UI.WebControls
{
	/// <summary>
	/// <summary>
	/// A delete dialog for DojoClassDefinition.
	/// </summary>
	/// </summary>
	[ToolboxData("<DojoClassDefinition:DojoClassDefinitionDeleteDialog runat=server></{0}:DojoClassDefinitionDeleteDialog>")]
	public class DojoClassDefinitionDeleteDialog : TableWindow
	{

		private int dojoClassDefinitionID = -1;
		...
		{
			DojoClassDefinition dojoClassDefinition = new DojoClassDefinition(dojoClassDefinitionID);
			dojoClassDefinition.Delete();

			dojoClassDefinitionID = 0;
		...
		protected override void RenderContent(HtmlTextWriter output)
		{
			if(dojoClassDefinitionID == 0)
			{
				...
				output.Write("The DojoClassDefinition selected does not exist.");
			...
			output.Write(HtmlTextWriter.TagRightChar);
			output.Write(dojoClassDefinition.ToString());
			output.WriteEndTag("td");
			output.WriteEndTag("tr");
