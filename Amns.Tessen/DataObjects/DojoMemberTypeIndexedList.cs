...
namespace Amns.GreyFox.Tessen
{
	...
	/// </summary>
	/// </summary>
	public class DojoMemberTypeIndexedList : IList, ICloneable 
	{
		private int count = 0;
		private int[,] index;
		private DojoMemberType[] DojoMemberTypeArray ;

		public DojoMemberTypeIndexedList() : base()
		{
			index = new int[15,2];
			DojoMemberTypeArray = new DojoMemberType[15];
		}

		public DojoMemberTypeIndexedList(int capacity) : base()
		{
		...
		public void RemoveAt(int index)
		{
			...
			lock(this)
			{
				removeIndexKey(DojoMemberTypeArray[index].ID);
