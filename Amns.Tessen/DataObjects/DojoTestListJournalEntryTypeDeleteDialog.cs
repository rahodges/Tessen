...
namespace Amns.Tessen.Web.UI.WebControls
{
	/// <summary>
	/// <summary>
	/// A delete dialog for DojoTestListJournalEntryType.
	/// </summary>
	/// </summary>
	[ToolboxData("<DojoTestListJournalEntryType:DojoTestListJournalEntryTypeDeleteDialog runat=server></{0}:DojoTestListJournalEntryTypeDeleteDialog>")]
	public class DojoTestListJournalEntryTypeDeleteDialog : TableWindow
	{

		private int dojoTestListJournalEntryTypeID = -1;
