...
namespace Amns.Tessen.Web.UI.WebControls
{
	/// <summary>
	/// <summary>
	/// A delete dialog for DojoSeminarOption.
	/// </summary>
	/// </summary>
	[ToolboxData("<DojoSeminarOption:DojoSeminarOptionDeleteDialog runat=server></{0}:DojoSeminarOptionDeleteDialog>")]
	public class DojoSeminarOptionDeleteDialog : TableWindow
	{

		private int dojoSeminarOptionID = -1;
		private DojoSeminarOption dojoSeminarOption;
		...
		protected override void RenderContent(HtmlTextWriter output)
		{
			if(dojoSeminarOptionID == 0)
			{
				...
				output.Write("The DojoSeminarOption selected does not exist.");
			...
			output.Write(HtmlTextWriter.TagRightChar);
			output.Write(dojoSeminarOption.ToString());
			output.WriteEndTag("td");
			output.WriteEndTag("tr");
