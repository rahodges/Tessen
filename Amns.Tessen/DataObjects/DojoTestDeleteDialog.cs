...
namespace Amns.Tessen.Web.UI.WebControls
{
	/// <summary>
	/// <summary>
	/// A delete dialog for DojoTest.
	/// </summary>
	/// </summary>
	[ToolboxData("<DojoTest:DojoTestDeleteDialog runat=server></{0}:DojoTestDeleteDialog>")]
	public class DojoTestDeleteDialog : TableWindow
	{

		private int dojoTestID = -1;
		...
		protected override void RenderContent(HtmlTextWriter output)
		{
			if(dojoTestID == 0)
			{
				...
				output.Write("The DojoTest selected does not exist.");
			...
			output.Write(HtmlTextWriter.TagRightChar);
			output.Write(dojoTest.ToString());
			output.WriteEndTag("td");
			output.WriteEndTag("tr");
