...
<%@ Page language="c#" CodeFile="DojoAccessControlGroupPage.aspx.cs" Inherits="TessenWeb.Administration.DojoAccessControlGroupPage" trace="false" %>
							...
							<tr>
								<td vAlign="top">
									<table id="LeftMenu" class="forumLine" cellSpacing="1" cellPadding="3" width="200" border="0">
										<tr><th>kitTessen_AccessControlGroups</th></tr>
										<tr><td> can be accessed here</td></tr>
									</table>
								</td>
								<td vAlign="top" width="100%">
									<cc1:DojoAccessControlGroupGrid id="DojoAccessControlGroupGrid1" runat="server" Width="100%" BorderWidth="0px" Height="100%" 
										...
										Text="kitTessen_AccessControlGroups"
										></cc1:DojoAccessControlGroupGrid>
									<cc1:DojoAccessControlGroupEditor id="DojoAccessControlGroupEditor1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text="kitTessen_AccessControlGroups Editor"
										></cc1:DojoAccessControlGroupEditor>
									<cc1:DojoAccessControlGroupView id="DojoAccessControlGroupView1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text="kitTessen_AccessControlGroups View"
										></cc1:DojoAccessControlGroupView>
								</td>
							</tr>
							<tr>
