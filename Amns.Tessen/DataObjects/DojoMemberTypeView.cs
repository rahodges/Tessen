...
namespace Amns.Tessen.Web.UI.WebControls
{
	...
	/// </summary>
	[ToolboxData("<DojoMemberType:DojoMemberTypeView runat=server></{0}:DojoMemberTypeView>")]
	public class DojoMemberTypeView : TableWindow, INamingContainer
	{
		...
		private Literal ltParentType = new Literal();
		...
		protected override void CreateChildControls()
		{
			...
			ltParentType.EnableViewState = false;
			Controls.Add(ltParentType);
		...
		protected override void RenderContent(HtmlTextWriter output)
		{
			...
			RenderRow("row1", "DojoMemberType ID", dojoMemberTypeID.ToString());
		...
		private void renderDefaultFolder(HtmlTextWriter output)
		{
			...
			output.WriteAttribute("class", "row2");
			output.Write(HtmlTextWriter.TagRightChar);
			ltParentType.RenderControl(output);
			output.WriteEndTag("td");
			output.WriteEndTag("tr");
