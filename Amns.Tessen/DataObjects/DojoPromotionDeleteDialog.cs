...
namespace Amns.Tessen.Web.UI.WebControls
{
	/// <summary>
	/// <summary>
	/// A delete dialog for DojoPromotion.
	/// </summary>
	/// </summary>
	[ToolboxData("<DojoPromotion:DojoPromotionDeleteDialog runat=server></{0}:DojoPromotionDeleteDialog>")]
	public class DojoPromotionDeleteDialog : TableWindow
	{

		private int dojoPromotionID = -1;
		...
		protected override void RenderContent(HtmlTextWriter output)
		{
			if(dojoPromotionID == 0)
			{
				...
				output.Write("The DojoPromotion selected does not exist.");
			...
			output.Write(HtmlTextWriter.TagRightChar);
			output.Write(dojoPromotion.ToString());
			output.WriteEndTag("td");
			output.WriteEndTag("tr");
