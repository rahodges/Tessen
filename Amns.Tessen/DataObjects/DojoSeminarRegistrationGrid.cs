...
namespace Amns.Tessen.Web.UI.WebControls
{
	...
	public class DojoSeminarRegistrationGrid : TableGrid
	{
		...
		protected override void RenderContent(HtmlTextWriter output)
		{
			...
			DojoSeminarRegistrationCollection dojoSeminarRegistrationCollection = m.GetCollection(string.Empty, string.Empty, null);
			// Render Header Row
			...
			// Render Records
			//
			foreach(DojoSeminarRegistration dojoSeminarRegistration in dojoSeminarRegistrationCollection)
			{
