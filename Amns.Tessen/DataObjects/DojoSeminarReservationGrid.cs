...
namespace Amns.Tessen.Web.UI.WebControls
{
	/// <summary>
	/// <summary>
	/// A custom grid for DojoSeminarReservation.
	/// </summary>
	/// </summary>
	[ToolboxData("<{0}:DojoSeminarReservationGrid runat=server></{0}:DojoSeminarReservationGrid>")]
	public class DojoSeminarReservationGrid : TableGrid
	{
