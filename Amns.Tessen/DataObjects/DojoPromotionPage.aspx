...
<%@ Page language="c#" CodeFile="DojoPromotionPage.aspx.cs" Inherits="TessenWeb.Administration.DojoPromotionPage" trace="false" %>
						...
						<table id="Table1" cellSpacing="0" cellPadding="3" width="100%" border="0" height="100%">
							...
							<tr>
								...
								<td vAlign="top" width="100%">
									<cc1:DojoPromotionGrid id="DojoPromotionGrid1" runat="server" Width="100%" BorderWidth="0px" Height="100%" 
										...
										Text=""
										></cc1:DojoPromotionGrid>
									<cc1:DojoPromotionEditor id="DojoPromotionEditor1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" Editor"
										></cc1:DojoPromotionEditor>
									<cc1:DojoPromotionView id="DojoPromotionView1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" View"
										></cc1:DojoPromotionView>
								</td>
							</tr>
							<tr>
