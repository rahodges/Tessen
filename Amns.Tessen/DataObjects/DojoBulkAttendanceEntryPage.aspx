...
<%@ Page language="c#" CodeFile="DojoBulkAttendanceEntryPage.aspx.cs" Inherits="TessenWeb.Administration.DojoBulkAttendanceEntryPage" trace="false" %>
							...
							<tr>
								<td vAlign="top">
									<table id="LeftMenu" class="forumLine" cellSpacing="1" cellPadding="3" width="200" border="0">
										<tr><th></th></tr>
										<tr><td>Bulk attendance entries for the bulk attendance log. can be accessed here</td></tr>
									</table>
								</td>
								<td vAlign="top" width="100%">
									<cc1:DojoBulkAttendanceEntryGrid id="DojoBulkAttendanceEntryGrid1" runat="server" Width="100%" BorderWidth="0px" Height="100%" 
										...
										Text=""
										></cc1:DojoBulkAttendanceEntryGrid>
									<cc1:DojoBulkAttendanceEntryEditor id="DojoBulkAttendanceEntryEditor1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" Editor"
										></cc1:DojoBulkAttendanceEntryEditor>
									<cc1:DojoBulkAttendanceEntryView id="DojoBulkAttendanceEntryView1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" View"
										></cc1:DojoBulkAttendanceEntryView>
								</td>
							</tr>
							<tr>
