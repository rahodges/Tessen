...
namespace Amns.Tessen.Web.UI.WebControls
{
	/// <summary>
	/// <summary>
	/// A delete dialog for DojoSeminarRegistrationOption.
	/// </summary>
	/// </summary>
	[ToolboxData("<DojoSeminarRegistrationOption:DojoSeminarRegistrationOptionDeleteDialog runat=server></{0}:DojoSeminarRegistrationOptionDeleteDialog>")]
	public class DojoSeminarRegistrationOptionDeleteDialog : TableWindow
	{

		private int dojoSeminarRegistrationOptionID = -1;
		...
		{
			DojoSeminarRegistrationOption dojoSeminarRegistrationOption = new DojoSeminarRegistrationOption(dojoSeminarRegistrationOptionID);
			dojoSeminarRegistrationOption.Delete();

			dojoSeminarRegistrationOptionID = 0;
		...
		protected override void OnPreRender(EventArgs e)
		{
			if(dojoSeminarRegistrationOptionID != 0)
			{
				...
				text = "Delete - " + dojoSeminarRegistrationOption.ToString();
			}
			else
			{
				text = "Delete ";
		...
		protected override void RenderContent(HtmlTextWriter output)
		{
			if(dojoSeminarRegistrationOptionID == 0)
			{
				...
				output.Write("The DojoSeminarRegistrationOption selected does not exist.");
			...
			output.Write(HtmlTextWriter.TagRightChar);
			output.Write(dojoSeminarRegistrationOption.ToString());
			output.WriteEndTag("td");
			output.WriteEndTag("tr");
