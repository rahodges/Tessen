...
<%@ Page language="c#" CodeFile="DojoSeminarOptionPage.aspx.cs" Inherits="TessenWeb.Administration.DojoSeminarOptionPage" trace="false" %>
						...
						<table id="Table1" cellSpacing="0" cellPadding="3" width="100%" border="0" height="100%">
							...
							<tr>
								...
								<td vAlign="top" width="100%">
									<cc1:DojoSeminarOptionGrid id="DojoSeminarOptionGrid1" runat="server" Width="100%" BorderWidth="0px" Height="100%" 
										...
										Text=""
										></cc1:DojoSeminarOptionGrid>
									<cc1:DojoSeminarOptionEditor id="DojoSeminarOptionEditor1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" Editor"
										></cc1:DojoSeminarOptionEditor>
									<cc1:DojoSeminarOptionView id="DojoSeminarOptionView1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" View"
										></cc1:DojoSeminarOptionView>
								</td>
							</tr>
							<tr>
