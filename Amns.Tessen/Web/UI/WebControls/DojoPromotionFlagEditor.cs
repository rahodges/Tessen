...
namespace Amns.Tessen.Web.UI.WebControls
{
	...
	[DefaultProperty("ConnectionString"), 
		ToolboxData("<{0}:DojoPromotionFlagEditor runat=server></{0}:DojoPromotionFlagEditor>")]
	public class DojoPromotionFlagEditor : TableWindow, INamingContainer
	{
		private int dojoPromotionFlagID;
		private DojoPromotionFlag editDojoPromotionFlag;
